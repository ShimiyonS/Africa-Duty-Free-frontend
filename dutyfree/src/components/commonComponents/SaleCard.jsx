...
const SaleCard = ({ data, imageClass, headingClass }) => {
  ...
  return (
    <div className='container'>
      <div className='sales-cards-container d-flex flex-wrap my-4 justify-content-center'>
        {finalData?.map((item, idx) => {
          return (<div key={idx}>
            <div className='col-12 col-md-4 sales-card'>
              <div className="image-container-salescard">
