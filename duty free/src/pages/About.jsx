...
const About = () => {
  return (
    <div className="container">
      <div className="d-block mt-5 d-lg-flex justify-content-center gap-2 about-main-div pb-5">
        ...
        <section class="aux-widget-modern-heading col-md-12 col-lg-6 col-sm-12">
          <div class="aux-widget-inner">
            ...
            <h3 class="about-content pb-5">Delivering exceptional duty-free services across Africa with unmatched quality and care.</h3>
