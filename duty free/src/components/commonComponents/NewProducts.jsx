...
const NewProducts = ({ heading, productsdata, parentClassName, headingClassName, swiperClassName, hideWishlist = false, hidePopTool = true, hideCart = false, hideAddCartPop = false }) => {
    return (
