        ...
        <>
            <div className="p-4">
                ...
                <div className="side-bar-links d-flex flex-column">
                    ...
                    <NavLink className="account-links text-decoration-none mb-1" to="/account/delete"><span className="px-3 sidebar-icons"><AiFillDelete /></span><span className="ps-3">Delete Account</span></NavLink>
                </div>
            </div>
        </>
    )
